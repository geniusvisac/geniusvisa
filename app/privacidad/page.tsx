  ...
  return (
    <main className="bg-[#1A3A3A] min-h-screen py-24 px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <h1 className="text-4xl text-white mb-2">Política de Privacidad</h1>
        ...
        {[
          ...
          { title: "7. Seguridad", body: "Aplicamos medidas técnicas y organizativas para proteger tu información contra acceso no autorizado, pérdida o alteración." },
          { title: "8. Cookies", body: "Utilizamos cookies técnicas necesarias para el funcionamiento del sitio y cookies analíticas para mejorar la experiencia. Puedes desactivarlas desde tu navegador." },
          { title: "9. Cambios en esta política", body: "Nos reservamos el derecho de actualizar esta política. La versión vigente estará siempre disponible en nuestro sitio web." },
        ].map((item) => (
        ...
        <div className="mt-16 text-center">
          <a href="/" className="inline-block border border-[#C9A84C] text-[#C9A84C] px-8 py-3 rounded-full text-sm hover:bg-[#C9A84C] hover:text-[#1A3A3A] transition-colors">
            Volver al inicio
          </a>
        </div>
      </div>

...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://genius-visa-and-travel.vercel.app/en/privacy',
  },
}
    ...
    <main className="bg-[#1A3A3A] min-h-screen py-24 px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mt-16 text-center">
          <a href="/en" className="inline-block border border-[#C9A84C] text-[#C9A84C] px-8 py-3 rounded-full text-sm hover:bg-[#C9A84C] hover:text-[#1A3A3A] transition-colors">
            Back to home
          </a>
        </div>
      </div>

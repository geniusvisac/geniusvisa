...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://genius-visa-and-travel.vercel.app/en/visas/f1',
  },
}
...
const visas = [
  {
    code: 'F1',
    title: 'F1 Visa — Academic Student',
    desc: 'The F1 visa is the most common for international students and allows full-time enrollment in academic programs at universities, colleges, seminaries, conservatories, and academic institutes approved by SEVP. F1 holders can work up to 20 hours per week on campus during the academic period and full-time during vacations.',
  },
  {
    code: 'M1',
    title: 'M1 Visa — Vocational Student',
    desc: 'The M1 visa is designed for students who want to pursue vocational or non-academic technical training programs at SEVP-approved institutions in the United States. It is ideal for culinary, mechanics, cosmetology, aviation, fashion design, and other technical disciplines. Unlike F1, M1 holders cannot work during their studies.',
  },
]
      ...
      <section className="py-32 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="font-heading text-5xl md:text-6xl text-white font-bold leading-tight mb-6">
            Student Visas<br/>F1 · M1
          </h1>
          <p className="text-white/70 text-lg max-w-2xl mx-auto leading-relaxed mb-10">
            Studying in the United States is one of the most important investments of your life. We accompany you every step of the way.
          </p>
      ...
      <section className="bg-[#F8F6F1] py-20 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-[#1A3A3A]/70 leading-relaxed mb-10">
            The United States offers two main types of visas for international students depending on the type of academic program they wish to pursue.
          </p>
      ...
      <section className="bg-white py-20 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {[
              'Admission letter from SEVP-approved institution',
              'I-20 form issued by the educational institution',
              ...
              'Program language proficiency or letter of acceptance with language requirement',
            ].map((req) => (

...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://genius-visa-and-travel.vercel.app/en/visas/familiares',
  },
}
...
const visas = [
  ...
  {
    code: 'F2',
    title: 'F2 Visa — F1 Student Dependent',

    ...
    <main className="bg-[#1A3A3A] min-h-screen">
      <section className="py-32 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-white/70 text-lg max-w-2xl mx-auto leading-relaxed mb-10">The B1/B2 visa is the most requested for traveling to the United States for tourism, visiting family, attending business conferences, or receiving medical treatment.</p>
      ...
      <section className="bg-[#F8F6F1] py-20 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-[#1A3A3A]/70 leading-relaxed mb-4">The B1/B2 visa is a temporary visitor visa that allows entry to the United States for tourism (B2) or business (B1) purposes. It is the most common visa and is generally granted for periods of up to 10 years with multiple entries.</p>
          <p className="text-[#1A3A3A]/70 leading-relaxed">With the B2 visa you can visit tourist destinations, visit relatives or friends, receive medical treatment, or participate in social events. With the B1 you can attend business meetings, conferences, negotiate contracts, or settle commercial matters, as long as you do not receive payment from a US source.</p>
        </div>
      </section>
      <section className="bg-white py-20 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {['Valid passport with at least 6 months of validity','DS-160 form completed correctly','Recent photo according to Department of State specifications','Proof of payment of MRV consular fee','Invitation letter or travel itinerary','Bank statements from the last 3-6 months','Employment letter or proof of income','Documents demonstrating ties to your home country'].map((req) => (

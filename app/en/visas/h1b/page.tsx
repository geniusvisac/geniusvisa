...
const visas = [
  ...
  { code: 'J1', title: 'J1 Visa — Cultural and Professional Exchange', desc: 'The J1 visa is an exchange visa that allows foreigners to participate in approved educational and cultural programs in the United States. Available for au pairs, students, professors, researchers, doctors, summer camp workers, trainees, and interns. Many J1 programs have a two-year home residency requirement.' },
]

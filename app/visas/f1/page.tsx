    ...
    <main className="bg-[#1A3A3A] min-h-screen">
      ...
      <section className="bg-[#F8F6F1] py-20 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-[#1A3A3A]/70 leading-relaxed mb-10">Estados Unidos ofrece dos tipos principales de visa para estudiantes internacionales según el tipo de programa académico que desean cursar. La diferencia clave está en el tipo de institución y programa — académico o vocacional.</p>

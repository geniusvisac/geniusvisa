...
const visas = [
  ...
  { code: 'F2', title: 'Visa F2 — Dependiente de Estudiante F1', desc: 'La visa F2 permite a los cónyuges e hijos menores de 21 años de titulares de visa F1 acompañar o unirse al estudiante durante su programa académico en Estados Unidos. Los titulares de F2 pueden vivir en el país mientras el estudiante principal mantenga su estatus F1 activo. Es importante destacar que los titulares de F2 no están autorizados a trabajar ni a estudiar a tiempo completo.' },
  { code: 'J2', title: 'Visa J2 — Dependiente de Intercambio J1', desc: 'La visa J2 está destinada a los cónyuges e hijos menores de 21 años de titulares de visa J1 que participan en programas de intercambio en Estados Unidos. A diferencia de otras visas de dependiente, los titulares de J2 pueden solicitar autorización de empleo independiente del titular J1, lo que la convierte en una de las visas de dependiente más flexibles disponibles.' },
]
    ...
    <main className="bg-[#1A3A3A] min-h-screen">
      ...
      <section className="bg-[#F8F6F1] py-20 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-[#1A3A3A]/70 leading-relaxed">El proceso de solicitud de estas visas está vinculado al estatus del titular principal. Por eso es fundamental contar con asesoría experta que garantice que toda la documentación esté correctamente preparada y que el proceso se realice en los tiempos adecuados.</p>
        </div>
      </section>

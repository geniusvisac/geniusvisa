  ...
  return (
    ...
    >
      ...
      <body className="font-sans antialiased" suppressHydrationWarning>
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-7E4P3MKT1L" />
        <script dangerouslySetInnerHTML={{ __html: `window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-7E4P3MKT1L');` }} />

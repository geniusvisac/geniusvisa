...
export function ExitPopup() {
  ...
  useEffect(() => {
    ...
    // En mobile: mostrar despues de 30 segundos
      ...
      <div className="relative w-full max-w-md rounded-2xl bg-[#1A3A3A] p-8 shadow-2xl ring-1 ring-white/10">
        ...
        {!sent ? (
          <>
            ...
            <ul className="space-y-2 mb-6">
              {[
                ...
                'Qué NO decir en la entrevista consular',
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <button
                type="submit"
                className="w-full rounded-full bg-[#C9A84C] py-3 text-sm font-bold text-[#1A3A3A] hover:opacity-90 transition-opacity"
              >
          ...
          <div className="text-center py-8">
            ...
            <h3 className="mt-4 font-heading text-2xl text-white font-bold">
              ¡Listo!
            </h3>
            <p className="mt-2 text-white/60 text-sm">
              Te enviamos la guía a <span className="text-[#C9A84C]">{email}</span>
            </p>

...
const columns = [
  ...
  {
    title: 'Países',
    links: ['Honduras', 'Colombia', 'México', 'Ecuador', 'España'],
  },
  {
    title: 'Empresa',
    links: ['Sobre nosotros', 'El Viajero Genius', 'Testimonios', 'Contacto'],
  },
  {
    title: 'Legal',
      ...
      <div className="mx-auto max-w-7xl px-5 md:px-8">
        ...
        <div className="mt-14 border-t border-white/10 pt-6">
          <p className="text-center text-xs text-offwhite/45">
            © 2026 Genius Visa Consultants · Genius VC Travel. Tegucigalpa,
            Honduras.
          </p>
        </div>
      </div>
